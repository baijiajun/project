    ...
    <div id="container">
       	...
       	<div class="sidebar">
            ...
            <!-- 对外合作广告位  -->
		            	...
		            	<img src="../storage/style/images/w3cplus.png" width="230" height="80" alt="w3cplus" />
		            </a>
		            <a href="" target="_blank" class="partnersAd">
		            	<img src="../storage/style/images/jquery_school.jpg" width="230" height="80" alt="JQ学校" />
		            </a>
		                                	            <a href="http://linux.cn/" target="_blank" class="partnersAd">
	            	<img src="../storage/style/images/linuxcn.png" width="230" height="80" alt="Linux中文社区"  />
	            </a>
	            <a href="http://zt.zhubajie.com/zt/makesite? utm_source=lagou.com&utm_medium=referral&utm_campaign=BD-yl" target="_blank" class="partnersAd">
	            	<img src="../storage/style/images/zhubajie.jpg" width="230" height="80" alt="猪八戒" />
	            </a>
	            <a href="http://www.imooc.com" target="_blank" class="partnersAd">
	            	<img src="../storage/style/images/muke.jpg" width="230" height="80" alt="幕课网" />
	            </a>
	        	       	<!-- 	            <a href="http://www.osforce.cn/" target="_blank" class="partnersAd">
	            	<img src="../storage/style/images/osf-lg.jpg" width="230" height="80" alt="开源力量"  />
	            </a>
	         -->
        </div>
        ...
        <div class="content">
        	<div id="search_box">
		<form action="index.php?r=resume/search_push" method="post">
        <ul id="searchType">
		    <input name="_csrf" type="hidden" id="_csrf" value="<?php echo  Yii::$app->request->csrfToken ?>">
            <input type="hidden" name="type" id="searchtype1">
        	<li data-searchtype="1" class="type_selected" value="zhiwei">职位</li>
        	<li data-searchtype="4" value="comp">公司</li>
        	        </ul>
...
<div class="hot_pos_l">
			                        <div class="mb10">
			                            <a href="h/jobs/86989.html" title="前端开发" target="_blank"><?php echo $v['name']?></a> 
			                            &nbsp;
			                            <span class="c9">[<?php echo $v['city']?>]</span>
			                            			                        </div>
			                        <span><em class="c7">月薪：</em><?php echo $v['month_scoge']?>K</span>
			                        ...
			                        <br />
			                        <span><?php echo $v['shihou']?>发布</span>
			                    </div> 
						        <div class="hot_pos_r">
			                        <div class="apply">
			                        <a href="toudi.html" target="_blank">投个简历</a>
			                        				                        </div>
			                        <div class="mb10"><a href="h/c/1712.html" title="紫色医疗" target="_blank"><?php echo $v['com_name']?></a></div>
			                        <span><em class="c7">领域： </em>移动互联网 ,健康医疗</span>
			                        			                        <span><em class="c7">创始人：</em> <?php echo $v['email']?></span>
			                        			                        <br />
