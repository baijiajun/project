<form action="<?php echo e(URL('/message')); ?>" method="post" enctype="multipart/form-data">
    <table>
...
*/    $.post("<?php echo e(URL('/message')); ?>",{title:title,content:content},function(msg){
      if(msg==1)
      {
        location.reload();
      }
