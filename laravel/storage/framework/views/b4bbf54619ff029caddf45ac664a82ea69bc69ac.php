    	...
    	<div class="wrapper">
    		...
    		<ul class="reset" id="navheader">
    			...
    			<li ><a href="h/toForum.html" target="_blank">论坛</a></li>
    				    			<li ><a href="<?=URL('/my_resume')?>" rel="nofollow">我的简历</a></li>
            	...
            	<li><a href="register.html" rel="nofollow">注册</a></li>
                            <li>|</li><li></li>
            	<li><a href="register.html" rel="nofollow">企业版</a></li>
            </ul>
                                </div>
    </div><!-- end #header -->
   <?php /* //职位无限级分类*/ ?>
    ...
    <div id="container">
		...
		<form id="searchForm" name="searchForm" action="list.html" method="get">
            <ul id="searchType">
                <input type="hidden" name="type" value="职位" id="searchtype1">
                <li data-searchtype="1" class="type_selected">职位</li>
                <li data-searchtype="4">公司</li>
            </ul>
        <div class="searchtype_arrow"></div>
        <input type="text" id="search_input" name = "kd"  tabindex="1" value=""  placeholder="请输入职位名称，如：产品经理"  />
       <?php /* <input type="hidden" name="spc" id="spcInput" value=""/>
       ...
       <?php /* <input type="hidden" name="labelWords" id="labelWords" value="" />
...
<script type="text/javascript" src="../storage/style/js/search.min.js"></script>
<dl class="hotSearch">
	<dt>热门搜索：</dt>
	...
	<dd><a href="list.html?gx=实习&city=">实习</a></dd>
			...
			<div id="home_banner">
	            <ul class="banner_bg">
	                    ...
	                    <a href="h/subject/s_buyfundation.html?utm_source=DH__lagou&utm_medium=banner&utm_campaign=haomai" target="_blank"><img src="../storage/style/images/d05a2cc6e6c94bdd80e074eb05e37ebd.jpg" width="612" height="160" alt="好买基金——来了就给100万" /></a>
	                </li>
	                	                <li  class="banner_bg_2" >
	                    <a href="h/subject/s_worldcup.html?utm_source=DH__lagou&utm_medium=home&utm_campaign=wc" target="_blank"><img src="../storage/style/images/c9d8a0756d1442caa328adcf28a38857.jpg" width="612" height="160" alt="世界杯放假看球，老板我也要！" /></a>
	                </li>
	                	                <li  class="banner_bg_3" >
	                    <a href="h/subject/s_xiamen.html?utm_source=DH__lagou&utm_medium=home&utm_campaign=xiamen" target="_blank"><img src="../storage/style/images/d03110162390422bb97cebc7fd2ab586.jpg" width="612" height="160" alt="出北京记——第一站厦门" /></a>
	                </li>
	                	            </ul>
	            <div class="banner_control">
	                ...
	                <ul class="thumbs">
	                        ...
	                        <i></i>
	                        <img src="../storage/style/images/4469b1b83b1f46c7adec255c4b1e4802.jpg" width="113" height="42" />
	                    </li>
	                    	                    <li  class="thumbs_2" >
	                        <i></i>
	                        <img src="../storage/style/images/381b343557774270a508206b3a725f39.jpg" width="113" height="42" />
	                    </li>
	                    	                    <li  class="thumbs_3" >
	                        <i></i>
	                        <img src="../storage/style/images/354d445c5fd84f1990b91eb559677eb5.jpg" width="113" height="42" />
	                    </li>
	                    	                </ul>
	            </div>
	        </div><!--/#main_banner-->
        	<ul id="da-thumbs" class="da-thumbs">
	                    ...
	                    <a href="h/c/1650.html" target="_blank">
	                        <img src="../storage/style/images/a254b11ecead45bda166afa8aaa9c8bc.jpg" width="113" height="113" alt="联想" />
	                        <div class="hot_info">
	                        	<h2 title="联想">联想</h2>
	                            <em></em>
	                            <p title="世界因联想更美好">
	                    ...
	                    <a href="h/c/9725.html" target="_blank">
	                        <img src="../storage/style/images/c75654bc2ab141df8218983cfe5c89f9.jpg" width="113" height="113" alt="淘米" />
	                        <div class="hot_info">
	                        	<h2 title="淘米">淘米</h2>
	                            <em></em>
	                            <p title="将心注入 追求极致">
	                    ...
	                    <a href="h/c/1914.html" target="_blank">
	                        <img src="../storage/style/images/2bba2b71d0b0443eaea1774f7ee17c9f.png" width="113" height="113" alt="优酷土豆" />
	                        <div class="hot_info">
	                    ...
	                    <a href="h/c/6630.html" target="_blank">
	                        <img src="../storage/style/images/f4822a445a8b495ebad81fcfad3e40e2.jpg" width="113" height="113" alt="思特沃克" />
	                        <div class="hot_info">
	                    ...
	                    <a href="h/c/2700.html" target="_blank">
	                        <img src="../storage/style/images/5caf8f9631114bf990f87bb11360653e.png" width="113" height="113" alt="奇猫" />
	                        <div class="hot_info">
	                        	<h2 title="奇猫">奇猫</h2>
	                            <em></em>
	                    ...
	                    <a href="h/c/1335.html" target="_blank">
	                        <img src="../storage/style/images/c0052c69ef4546c3b7d08366d0744974.jpg" width="113" height="113" alt="堆糖网" />
	                        <div class="hot_info">
	                        	<h2 title="堆糖网">堆糖网</h2>
	                            <em></em>
                    ...
                    <div id="hotList">
                        ...
                        ?>
                            ...
                            <ul class="hot_pos reset">
                                <li class="clearfix" style="width:600px;">
                                    <?php foreach($new_post as $k=>$v){ ?>
                                    <div class="hot_pos_l">

                                        <div class="mb10">

                                            <a href="?r=post/position&pos_id=<?php echo $v['pos_id']?>" target="_blank"><?php echo $v['name']?></a>
                                            &nbsp;
                                            <span class="c9"><?php echo $v['city']?></span>
                                        </div>
                                        <div class="mb0">
                                            <span><em class="c7">月薪： </em><?php echo $v['month_scoge']?></span>
                                            <br/>
                                            <span><em class="c7">经验：</em><?php echo $v['work_exp']?></span>
                                            <br/>
                                            <span><em class="c7">最低学历： </em><?php echo $v['edu_dmand']?></span>
                                            <br/>

                                            <span><em class="c7">职位诱惑：</em><?php echo $v['post_tempt']?></span>
                                            <br />
                                            <span><em class="c7">发布时间：</em><?php echo $v['issue_time']?></span>
                                        </div>
                                        <!-- <a  class="wb">分享到微博</a> -->
                                    </div>
                                    <div class="mb10 recompany"><a href="?r=company/comp_details&com_id=<?=$v['com_id']?>">公司简介</a></div>

                                    <span><em 	class="c7">公司名称：</em> <?php echo $v['com_name']?></span><br/>
                                    <span><em class="c7">公司口号：</em>团结</span>


                                    </br>
                                    <span><em class="c7">公司地址</em><?php echo $v['com_address']?></span>
                                    </br>
...
<!-- <div id="loginToolBar">
	<div>
		<em></em>
		<img src="../storage/style/images/footbar_logo.png" width="138" height="45" />
...
<!------------------------------------- end ----------------------------------------->
<script type="text/javascript" src="../storage/style/js/Chart.min.js"></script>
<script type="text/javascript" src="../storage/style/js/home.min.js"></script>
<script type="text/javascript" src="../storage/style/js/count.js"></script>
			<div class="clear"></div>
...
<!-- <script src="../storage/style/js/wb.js" type="text/javascript" charset="utf-8"></script>
 -->
