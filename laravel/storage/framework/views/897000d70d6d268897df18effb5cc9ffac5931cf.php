...
<html xmlns:wb="http://open.weibo.com/wb"><head>
    </script><script type="text/javascript" async="" src="../storage/style/js/conversion.js"></script><script src="../storage/style/js/allmobilize.min.js" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>
    <meta content="no-siteapp" http-equiv="Cache-Control">
    <link  media="handheld" rel="alternate">
    <!-- end 云适配 -->
    <meta content="text/html; charset=utf-8" http-equiv="Content-Type">
    <title>我的简历-拉手网-最专业的互联网招聘平台</title>
    ...
    <link href="../storage/style/css/style.css" type="text/css" rel="stylesheet">
    <link href="../storage/style/css/external.min.css" type="text/css" rel="stylesheet">
    <link href="../storage/style/css/popup.css" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="../storage/style/js/jquery.1.10.1.min.js"></script>
    <script src="../storage/style/js/jquery.lib.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="../storage/style/js/ajaxfileupload.js"></script>
    <script src="../storage/style/js/additional-methods.js" type="text/javascript"></script>
    ...
    <script src="../storage/style/js/conv.js" type="text/javascript"></script>
    <script src="../storage/style/js/ajaxCross.json" charset="UTF-8"></script></head>
<body>
...
<div id="body">
    ...
    <div id="container">
        ...
        <div class="clearfix">
            <div class="content_l">
                ...
                <div class="profile_box" id="basicInfo">
                    ...
                    <div class="basicShow">
	            		...
	            		<span>
	            			<?php echo $m_message['name']?> |  <?php echo $m_message['sex']?>  | <?php echo $m_message['education']?> |  <?php echo $m_message['workyear']?><br>
                            <?php echo $m_message['phone']?> | <?php echo $m_message['email']?><br>
	            		</span>
                        ...
                        <div class="m_portrait">
                            <div></div>
                            <img width="120" height="120" alt="jason" src="../storage/style/images/default_headpic.png">
                        </div>
                    </div><!--end .basicShow-->
                        ...
                        <form id="profileForm">
                            ...
                            <table>
                                <tbody><tr>
                                    ...
                                    <td>
                                        <input type="text" placeholder="姓名"  value="<?php echo $m_message['name']?>"
                                    ...
                                    <td>
                                        <ul class="profile_radio clearfix reset">
                                            <li class="current">
                                                男<em></em>
                                                <input type="radio" checked="checked" name="sex" class="sex"  value="男">
                                            </li>
                                            <li>
                                                女<em></em>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" id="education" value="大专" name="education" class="education">
                                    ...
                                    <td>
                                        <input type="hidden" id="workyear" value="" name="workyear" class="workyear">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="text" placeholder="手机号码" value="<?php echo $m_message['phone']?>" name="phone" class="phone">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                    ...
                                    <td colspan="3">
                                        <input type="text" placeholder="接收面试通知的邮箱" value="<?php echo $m_message['email']?>" name="email" class="email">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top"> </td>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <input type="button" value="目前状态" id="select_currentState" class="profile_select_410 profile_select_normal state">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <input type="button"  id="my_message" value="保 存" class="btn_profile_save" >
                            ...
                            <table>
                                <tbody><tr>
                                    <td>
                                        ...
                                        <input type="text" placeholder="期望城市，如北京" value="<?php echo $my_resumes['city']?>" name="city" class="city">
                                    ...
                                    <td>
                                        <ul class="profile_radio clearfix reset">
                                            <li class="current">
                                                全职<em></em>
                                                <input type="radio" checked="" name="work_state" class="work_state" value="全职">
                                            </li>
                                            <li>
                                                兼职<em></em>
                                                <input type="radio" name="work_state" class="work_state" value="兼职">
                                            </li>
                                            <li>
                                                实习<em></em>
                                                <input type="radio" name="work_state" class="work_state" value="实习">
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" placeholder="期望职位，如：产品经理" value="<?php echo $my_resumes['post']?>" name="post" class="post">
                                    </td>
                                    <td>
                                        <input type="text" placeholder="期望薪资，如10K" value="<?php echo $my_resumes['month']?>" name="month" class="month">
                                    </td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <input type="submit" value="保 存" id="my_work" class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                        ...
                        <form class="experienceForm">
                            <table>
                                <tbody><tr>
                                    ...
                                    <td>
                                        <input type="text" value="<?php echo $my_resumes['wor_comname']?>" placeholder="公司名称" name="wor_comname" class="wor_comname"  >
                                    </td>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    </td>
                                    <td>
                                        <input type="text" value="<?php echo $my_resumes['wor_post']?>" placeholder="职位名称，如：产品经理" name="wor_post" class="wor_post" >
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                    ...
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="companyYearStart ws_year" value="" name="ws_year" id="ws_year">
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="companyMonthStart ws_month" value="" name="ws_month" id="ws_month">
                                    ...
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="companyYearEnd we_year" value="" name="we_year" id="we_year">
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="companyMonthEnd we_month" value="" name="we_month" id="we_month">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <input type="submit" id="last_work" value="保 存" class="btn_profile_save">						          		<a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                        ...
                        <form class="projectForm">
                            <table>
                                <tbody><tr>
                                    ...
                                    <td>
                                        <input type="text" value="<?php echo $my_resumes['item_name']?>" placeholder="项目名称" name="item_name"  class="item_name">
                                    </td>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    </td>
                                    <td>
                                        <input type="text" value="<?php echo $my_resumes['item_post']?>" placeholder="担任职务，如：产品负责人" name="item_post"  class="item_post">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                    ...
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="projectYearStart is_year" value="" name="is_year" >
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="projectMonthStart is_month" value="" name="is_month" >
                                    ...
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="projectYearEnd ie_year" value="" name="ie_year" >
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="projectMonthEnd ie_month" value="" name="ie_month" >
                                ...
                                <tr>
                                    <td valign="top"></td>
                                    <td colspan="3">
                                        <textarea class="projectDescription s_textarea item_desc" name="item_desc"   placeholder="项目描述"><?php echo $my_resumes['item_desc']?></textarea>
                                ...
                                <tr>
                                    <td valign="top"></td>
                                    <td colspan="3">
                                        <input type="submit" value="保 存" id="last_item" class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                        ...
                        <form class="educationalForm">
                            <table>
                                <tbody><tr>
                                    ...
                                    <td>
                                        <input type="text" placeholder="学校名称" name="stu_name" value="<?php echo $my_resumes['stu_name']?>" id="stu_name" class="stu_name">
                                    </td>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    </td>
                                    <td>
                                        <input type="hidden" class="degree stu_edu" value="" name="stu_edu" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" placeholder="专业名称" name="major_name" value="<?php echo $my_resumes['major_name']?>" class="major_name">
                                    </td>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    </td>
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="schoolYearStart major_begtime" value="" name="major_begtime" >
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="schoolYearEnd major_endtime" value="" name="major_endtime" >
                                ...
                                <tr>
                                    <td></td>
                                    <td colspan="3">
                                        <input type="submit" value="保 存" id="last_study" class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                    ...
                    <div class="descriptionEdit dn">
                        <form class="descriptionForm">
                            <table>
                                <tbody><tr>
                                    <td colspan="2">
                                        <textarea class="selfDescription s_textarea self_desc" name="self_desc"  placeholder="自我描述">11111</textarea>
                                        <!-- <div class="word_count">你还可以输入 <span>500</span> 字</div> -->
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <input type="submit" value="保 存" id="my_desc" class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                    ...
                    <div class="workEdit dn">
                        <form class="workForm">
                            <table>
                                <tbody><tr>
                                    <td>
                                        <input type="text" placeholder="请输入作品链接" name="opus_url" value="<?php echo $my_resumes['opus_url']?>" class="opus_url">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <textarea maxlength="100" class="workDescription s_textarea opus_exp" name="opus_exp"  .. placeholder="请输入说明文字"><?php echo $my_resumes['opus_url']?></textarea>
                                        <!-- <div class="word_count">你还可以输入 <span>100</span> 字</div> -->
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input type="submit" value="保 存" id="my_works" class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
            ...
            <div class="content_r">
                ...
                <div class="greybg qrcode mt20">
                    <img width="242" height="242" alt="拉勾微信公众号二维码" src="../storage/style/images/qr_resume.png">
        ...
        <div style="display:none;">
            ...
            <div class="popup" id="uploadFile">
                <table width="100%">
                    ...
                    <tr>
                        <td align="center"><img width="55" height="16" alt="loading" style="visibility: hidden;" id="loadingImg" src="../storage/style/images/loading.gif"></td>
                    </tr>
                    </tbody></table>
            </div><!--/#uploadFile-->
        ...
        <script src="../storage/style/js/Chart.min.js" type="text/javascript"></script>
        <script src="../storage/style/js/profile.min.js" type="text/javascript"></script>
...
<script src="../storage/style/js/core.min.js" type="text/javascript"></script>
<script src="../storage/style/js/popup.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    $("#my_message").click(function(){
        ...
        var url="index.php?r=resume/resume_info";


        //调用jquery的get方法
        $.get(url,{'name':name,'sex':sex,'education':education,'phone':phone,'email':email,'state':state,'workyear':workyear},function(msg){
            if(msg==1){
                alert('保存成功');
            }else{
                alert('保存失败');
    ...
    $("#my_work").click(function(){
        ...
        var url="index.php?r=resume/resume_work";


        //调用jquery的get方法
        $.get(url,{'city':city,'work_state':work_state,'post':post,'month':month},function(msg){
            if(msg==1){
                alert('保存成功');
            }else{
                alert('保存失败');
    ...
    //工作经历保存
    $("#last_work").click(function(){

        var wor_comname=$('.wor_comname').val();
        var wor_post=$('.wor_post').val();
        var ws_year=$('.ws_year').val();
        var ws_month=$('.ws_month').val();
        var we_year=$('.we_year').val();
        var we_month=$('.we_month').val();

        var wor_begtime=ws_year+'-'+ws_month;
        var wor_endtime=we_year+'-'+we_month;
        var url="index.php?r=resume/resume_last_work";


        //调用jquery的get方法
        $.get(url,{'wor_comname':wor_comname,'wor_post':wor_post,'wor_begtime':wor_begtime,'wor_endtime':wor_endtime},function(msg){
            if(msg==1){
                alert('保存成功');
            }else{
                alert('保存失败');
    ...
    $("#last_item").click(function(){
        ...
        var item_post=$('.item_post').val();
        var is_year=$('.is_year').val();
        var is_month=$('.is_month').val();
        var ie_year=$('.ie_year').val();
        var ie_month=$('.ie_month').val();
        var item_desc=$('.item_desc').val();

        var item_begtime=is_year+'-'+is_month;
        var item_endtime=ie_year+'-'+ie_month;
        var url="index.php?r=resume/resume_last_item";


        //调用jquery的get方法
        $.get(url,{'item_name':item_name,'item_post':item_post,'item_begtime':item_begtime,'item_endtime':item_endtime,'item_desc':item_desc},function(msg){
            if(msg==1){
                alert('保存成功');
            }else{
                alert('保存失败');
    ...
    //教育背景保存
    $("#last_study").click(function(){

        var stu_name=$('.stu_name').val();
        var stu_edu=$('.stu_edu').val();
        var major_name=$('.major_name').val();
        var major_begtime=$('.major_begtime').val();
        var major_endtime=$('.major_endtime').val();

        var url="index.php?r=resume/resume_last_study";


        //调用jquery的get方法
        $.get(url,{'stu_name':stu_name,'stu_edu':stu_edu,'major_name':major_name,'major_begtime':major_begtime,'major_endtime':major_endtime},function(msg){
            if(msg==1){
                alert('保存成功');
            }else{
                alert('保存失败');
    ...
    //自我描述保存
    $("#my_desc").click(function(){

        var self_desc=$('.self_desc').val();

        var url="index.php?r=resume/resume_my_desc";

        //调用jquery的get方法
        $.get(url,{'self_desc':self_desc},function(msg){
            if(msg==1){
                alert('保存成功');
            }else{
                alert('保存失败');
    ...
    //作品展示保存
    $("#my_works").click(function(){


        var opus_url=$('.opus_url').val();
        var opus_exp=$('.opus_exp').val();

        var url="index.php?r=resume/resume_my_opus";

        //调用jquery的get方法
        $.get(url,{'opus_url':opus_url,'opus_exp':opus_exp},function(msg){
            if(msg==1){
                alert('保存成功');
            }else{
                alert('保存失败');
